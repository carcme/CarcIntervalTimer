...
public class IntentUtils {
    ...
    private static String marketPrefix() {
     ...
     */
    private static Intent openPlayStore(Context ctx, boolean openInBrowser) {
     ...
     */
    @SuppressWarnings({""})
    private static Intent sendEmail(String[] to, String subject, String text) {
