 ...
 */
public class TimePick extends FrameLayout {
    ...
    public interface OnTimeChangedListener {
         ...
         */
        void onTimeChanged(TimePick view, int hourOfDay, int minute, int seconds);
    }
    ...
    public TimePick(Context context, AttributeSet attrs, int defStyle) {
