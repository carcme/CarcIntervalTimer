...
public class Exercise extends DatabaseModel implements Cloneable {
	...
	private WorkoutItem exerciseGroup;
	...
	public Exercise(int duration, EffortLevel effortLevel, WorkoutItem node) {
		this.duration = duration;
		this.effortLevel = effortLevel;
		this.exerciseGroup = node;
	}

	public Exercise(String name, int duration, EffortLevel effortLevel, WorkoutItem node) {
	...
	public WorkoutItem getParentNode() {
		return exerciseGroup;
	}

	public void setNode(WorkoutItem exerciseGroup) {
	...
	public int getMinutes() {
		return ViewUtil.getMinutesFromMs(duration);
	}
	...
	public int getSeconds() {
		return ViewUtil.getSecondsFromMs(duration);
	}
